...
public class AccountServiceImpl implements AccountService {
    ...
    public void debit(String userId, int money) {
        LOGGER.info("Account Service ... 事务ID - xid: " + RootContext.getXID());
        ...
        String remind = jdbcTemplate.queryForObject(sql, String.class, userId);
        if(money > Integer.parseInt(remind)){
